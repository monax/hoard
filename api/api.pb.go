...
import (
	...
	grant "github.com/monax/hoard/v6/grant"
	meta "github.com/monax/hoard/v6/meta"
	reference "github.com/monax/hoard/v6/reference"
	stores "github.com/monax/hoard/v6/stores"
...
type PlaintextAndMeta struct {
	// Types that are valid to be assigned to Input:
	//	*PlaintextAndMeta_Meta
	//	*PlaintextAndMeta_Plaintext
	Input                isPlaintextAndMeta_Input `protobuf_oneof:"input"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
type isPlaintextAndMeta_Input interface {
	isPlaintextAndMeta_Input()
}

type PlaintextAndMeta_Meta struct {
	Meta *meta.Meta `protobuf:"bytes,1,opt,name=Meta,proto3,oneof"`
}
type PlaintextAndMeta_Plaintext struct {
	Plaintext *Plaintext `protobuf:"bytes,2,opt,name=Plaintext,proto3,oneof"`
}

func (*PlaintextAndMeta_Meta) isPlaintextAndMeta_Input()      {}
func (*PlaintextAndMeta_Plaintext) isPlaintextAndMeta_Input() {}

func (m *PlaintextAndMeta) GetInput() isPlaintextAndMeta_Input {
	if m != nil {
		return m.Input
	}
	return nil
...
func (m *PlaintextAndMeta) GetMeta() *meta.Meta {
	if x, ok := m.GetInput().(*PlaintextAndMeta_Meta); ok {
		return x.Meta
	}
	return nil
}
...
func (m *PlaintextAndMeta) GetPlaintext() *Plaintext {
	if x, ok := m.GetInput().(*PlaintextAndMeta_Plaintext); ok {
		return x.Plaintext
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*PlaintextAndMeta) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*PlaintextAndMeta_Meta)(nil),
		(*PlaintextAndMeta_Plaintext)(nil),
	}
}

type PlaintextAndGrantSpecAndMeta struct {
	// Types that are valid to be assigned to Input:
	//	*PlaintextAndGrantSpecAndMeta_Meta
	//	*PlaintextAndGrantSpecAndMeta_PlaintextAndGrantSpec
	Input                isPlaintextAndGrantSpecAndMeta_Input `protobuf_oneof:"input"`
	XXX_NoUnkeyedLiteral struct{}                             `json:"-"`
	XXX_unrecognized     []byte                               `json:"-"`
	XXX_sizecache        int32                                `json:"-"`
}
...
type isPlaintextAndGrantSpecAndMeta_Input interface {
	isPlaintextAndGrantSpecAndMeta_Input()
}

type PlaintextAndGrantSpecAndMeta_Meta struct {
	Meta *meta.Meta `protobuf:"bytes,1,opt,name=Meta,proto3,oneof"`
}
type PlaintextAndGrantSpecAndMeta_PlaintextAndGrantSpec struct {
	PlaintextAndGrantSpec *PlaintextAndGrantSpec `protobuf:"bytes,2,opt,name=PlaintextAndGrantSpec,proto3,oneof"`
}

func (*PlaintextAndGrantSpecAndMeta_Meta) isPlaintextAndGrantSpecAndMeta_Input()                  {}
func (*PlaintextAndGrantSpecAndMeta_PlaintextAndGrantSpec) isPlaintextAndGrantSpecAndMeta_Input() {}

func (m *PlaintextAndGrantSpecAndMeta) GetInput() isPlaintextAndGrantSpecAndMeta_Input {
	if m != nil {
		return m.Input
	}
	return nil
...
func (m *PlaintextAndGrantSpecAndMeta) GetMeta() *meta.Meta {
	if x, ok := m.GetInput().(*PlaintextAndGrantSpecAndMeta_Meta); ok {
		return x.Meta
	}
	return nil
}
...
func (m *PlaintextAndGrantSpecAndMeta) GetPlaintextAndGrantSpec() *PlaintextAndGrantSpec {
	if x, ok := m.GetInput().(*PlaintextAndGrantSpecAndMeta_PlaintextAndGrantSpec); ok {
		return x.PlaintextAndGrantSpec
	}
	return nil
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*PlaintextAndGrantSpecAndMeta) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*PlaintextAndGrantSpecAndMeta_Meta)(nil),
		(*PlaintextAndGrantSpecAndMeta_PlaintextAndGrantSpec)(nil),
	}
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
