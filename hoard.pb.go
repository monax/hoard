...
func (*GrantAndGrantSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5a6d89c8778bfa9, []int{0}
}
...
func (*PlaintextAndGrantSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5a6d89c8778bfa9, []int{1}
}
...
func (*ReferenceAndGrantSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5a6d89c8778bfa9, []int{2}
}
...
func (*Plaintext) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5a6d89c8778bfa9, []int{3}
}
...
func (*Ciphertext) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5a6d89c8778bfa9, []int{4}
}
...
func (*ReferenceAndCiphertext) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5a6d89c8778bfa9, []int{5}
}
...
func (*Address) Descriptor() ([]byte, []int) {
	return fileDescriptor_f5a6d89c8778bfa9, []int{6}
}
...
func init() { proto.RegisterFile("hoard.proto", fileDescriptor_f5a6d89c8778bfa9) }

var fileDescriptor_f5a6d89c8778bfa9 = []byte{
