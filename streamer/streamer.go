...
// new Input/Output would need normally need to be provided for reuse of a streamer
// but we leave that to the caller, since it is possible to call WithInput/WithOutput again
// we will reset our internal state
